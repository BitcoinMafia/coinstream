 ...
 *
 * <pre>
 *   csAppDev = angular.module('csAppDev', ['csApp', 'ngMockE2E']);
 *   csAppDev.run(function($httpBackend) {
...
(window.jasmine || window.mocha) && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('csApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('csApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('csApplicationModule'));
   *
   *
